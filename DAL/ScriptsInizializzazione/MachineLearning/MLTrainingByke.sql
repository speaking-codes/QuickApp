...
select	
		...
		p.reddito, cl.cod_fascia_reddito, pr.sigla_provincia, pr.cod_regione, 'B01'
...
where	(pa.cod_settore_tariffario = '4' or pa.cod_settore_tariffario = '5') 
...
select	'insert	into Temp(Gender, BirthDate, MaritalStatusCode, FamilyTypeCode, ChildrenNumbers, IncomeTypeCode, ProfessioneTypeCode, ProfessioneTypeCode_1, ProfessioneTypeCode_2,
		...
		case when RegionCode is null then 'null, ' else '''' + RegionCode + ''', ' end + 'B01'
