...
var host = new HostBuilder()
    .ConfigureFunctionsWorkerDefaults()
        .ConfigureServices(services =>
        {
            ...
            services.AddTransient<IInsuranceCategoryPolicyRecommendationRepository, InsuranceCategoryPolicyRecommendationRepository>(x => new InsuranceCategoryPolicyRecommendationRepository(x.GetRequiredService<IMongoDbContext>(), "InsuranceCoverageRecommendation"));
